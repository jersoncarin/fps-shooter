 ...
 * Integrates Pointer Lock API and Cannon.js for first-person controls.
 * credits to the owner @author mrdoob / http://mrdoob.com/
 * i just converted it to typescript
 */
